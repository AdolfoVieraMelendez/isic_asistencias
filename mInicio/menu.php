...
<ul class="list-unstyled components">
    ...
    <li class="active activado" id="liContras">
        <a href="#" id="btnCambiarContraMenu"><i class="fas fa-key"></i> Cambiar Contraseña</a>
    </li>
    <li class="active activado">
        ...
        <?php
            ...
            ?>
            <li>
                <a href="javascript:aplicarTema(<?php echo $rowMenu[0]?>,'enlace')" class="enlace sfx"><i class="fas fa-angle-right"></i> <?php echo $rowMenu[1]?></a>
            </li>
            <?php } ?>
        </ul>
    </li>
